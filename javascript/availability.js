const statusBadge = document.getElementById("statusBadge"); //leyenda superior
const changeStatus = document.getElementById("changeStatus"); //botón
const statusTxt = document.getElementById("statusTxt"); //leyenda inferior
let available = true;
